  ...
  public  class BlogService:IBlogService
    {
        ...
        {
            Blog blog = await _unitOfWork.BlogRepository.GetAsync(x => x.Id == id, "BlogLanguages.Language","Position");
        ...
        {
            var query = _unitOfWork.BlogRepository.GetAll(x => x.Id != null, "BlogLanguages.Language", "Position");
